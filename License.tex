...
\begin{wrapfigure}{T}{0.33\textwidth}
\raisebox{0pt}[\dimexpr\height-0.6\baselineskip\relax]
\centering
\includegraphics[width=0.30\textwidth]{hololens}
\caption{\label{fig:hololens} HoloLens Glasses}
\end{wrapfigure}
...
The levels are organised in chapters based on their difficulty and on the aspects that they emphasise.
